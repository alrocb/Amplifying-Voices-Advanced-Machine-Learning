...
tokenizer = Wav2Vec2CTCTokenizer("/fhome/amlai08/ALEX/FINETUNING/vocabdefinitivo.json", unk_token="[UNK]", pad_token="[PAD]", word_delimiter_token="|")
...
save_path = "./preprocessed_audio_dataset2"
