...
local_model_path = "/fhome/pmlai03/AMLALEX/FINETUNE-ENG-CA/modeleng"
...
model.save_pretrained("./fine-eng-to-cat")
processor.save_pretrained("./fine-eng-to-cat")
